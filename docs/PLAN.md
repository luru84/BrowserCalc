...
| ID | フェーズ | 内容 | 優先度 | 担当 | 見積り |
|---|---|---|---|---|---|
| T1 | P1 | 逐次計算ロジック（四則/連続`=`/符号/クリア/⌫/CE）とテスト | High | TBD | 1d |
| T2 | P1 | パーセント挙動・税計算（丸め）・桁/精度バリデーション | High | TBD | 1d |
| T3 | P2 | UI骨格（表示/テンキー/演算/税/メモリ）レスポンシブ対応 | High | TBD | 1d |
| T4 | P3 | 設定UI（税率/表示/テーマ）+ 永続化 | Med | TBD | 1d |
| T5 | P4 | 履歴（保存/上限/再利用/コピー/クリア） | Med | TBD | 1d |
| T6 | P5 | 式評価モード（パース/評価/切替UI） | Med | TBD | 2d |
| T7 | P6 | キーボード入力とショートカット競合回避 | Med | TBD | 0.5d |
| T8 | P7 | PWA（manifest/Service Worker）、オフライン確認 | Low | TBD | 1d |
| T9 | P8 | E2E/手動確認、README更新 | High | TBD | 1d |
